...
!!! mexample "_Example and Motivation_"
...
!!! def "_Definition: The Propositional Calculus Alphabet_"
...
!!! def "_Definition: Set of Propositions_"
...
!!! claim "_Claim: Induction on Numbers_"
...
!!! claim "_Claim: Structural Induction_"
...
!!! mexample "_Example: Even Number of Parentheses_"
...
!!! mexample "_Example: Parentheses and Connectives_"
...
!!! mexample "_Example: Inductive Definitions_"
...
!!! def "_Definition: Rank_"
    We define a Rank function from formulas to natural numbers:
    * $Rank(var) = 1$
    * $Rank((\varphi \text{ op } \psi)) = \max(Rank(\varphi), Rank(\psi)) + 1$
...
!!! def "_Definition: Formation Sequence_"
...
!!! mexample "_Examples of Formation Sequences_"
...
!!! claim "_Claim: Every formula has a formation sequence_"
...
!!! claim "_Claim: Validity of a Formation Sequence_"
...
!!! def "_Definition: Parentheses Saving Rules_"
...
!!! thm "_Theorem: Unique Readability_"
...
!!! def "_Definition: Simultaneous Substitution_"
...
!!! claim "_Claim: Substitution is Non-Commutative_"
